...
#define ISO14443B_SUCCESSCODE											0x00
#define ISO14443B_ERRORCODE_DEFAULT								0x71
#define ISO14443B_ERRORCODE_CRC										0x72
#define ISO14443B_ERRORCOD_NOTAG            1
#define ISO14443B_ERRORCOD_REQB             2
#define ISO14443B_ERRORCOD_ANTICOLLB         3
#define ISO14443B_ERRORCOD_SELECTB          4
#define ISO14443B_ERRORCOD_HALTB            5
...
#define ISO14443B_MAX_UID_SIZE	           			20
#define ISO14443B_ATQB_SIZE	           				13
#define ISO14443B_SeleckB_SIZE                      5
...
typedef struct{
	...
	uint8_t 	UIDsize;                    //¿¨ºÅ³¤¶È
	uint8_t 	UID[ISO14443B_MAX_UID_SIZE];//¿¨ºÅ
