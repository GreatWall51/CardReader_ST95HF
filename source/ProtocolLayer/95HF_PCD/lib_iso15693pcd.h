...
#define ISO15693_LOW_DENSITY						0x00 //低容量，256Byte
#define ISO15693_STLEGLR_HIGH_DENSITY				0x01
#define ISO15693_HIGH_DENSITY						0x02 //高容量，64kByte

#define ISO15693_NBBYTE_BLOCKLENGTH 				4

/* mask of request flag ----------------------------------------------------------------------- */
#define ISO15693_MASK_SUBCARRIERFLAG    		0x01 //副载波标志
#define ISO15693_MASK_DATARATEFLAG	    		0x02 //数据速率标志
#define ISO15693_MASK_INVENTORYFLAG	  			0x04 //目录标志
#define ISO15693_MASK_PROTEXTFLAG    			0x08 //协议拓展标志
#define ISO15693_MASK_SELECTORAFIFLAG 			0x10 //选择标志或应用族标志
#define ISO15693_MASK_ADDRORNBSLOTSFLAG 		0x20 //寻址标志或槽标志
#define ISO15693_MASK_OPTIONFLAG 				0x40 //选择权标志
#define ISO15693_MASK_RFUFLAG 					0x80 //保留
...
int8_t 		DataRate		,	// 0 => 26k 	1 => 52 k 	2 => 6k	3=>RFU
					WaitOrSOF		,	// 0 => respect 312 祍 	1=> wait for SOF
