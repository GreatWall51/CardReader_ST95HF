...
#define RFTRANS_95HF_SUCCESS_CODE															0x00
...
#define RFTRANS_95HF_RESPONSEBUFFER_SIZE											0X100 //0x20E
#define RFTRANS_95HF_MAX_BUFFER_SIZE													0X12c //0x20E
...
//命令格式: cmd + len +data 所以命令的偏移地址为0,长度的偏移地址为1,数据的偏移地址为2,
